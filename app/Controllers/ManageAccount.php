...
class ManageAccount
{
    ...
    public static function action()
    {
        ...
        switch ($action) {
            ...
            case "reset_pwd":
                ...
                $msg = "Le mot de passe a bien été réinitialisé avec le mot de passe suivant : threenity213!";
    ...
    public static function addAccount()
    {
        ...
        //TODO: Add password complexity validation if the application is widely used.
