...
class Utils
{
     ...
     */
    public static function getQueryLink($product)
    {
        echo "<a class='btn btn-default btn-flat btn-xs' title='Voir la fiche du produit " . $product . "' data-toggle='tooltip' href='" . Path::root() . "/views/query-product.php?product=$product'>$product</a>";
    }
}