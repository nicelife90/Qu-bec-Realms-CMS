...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Accounts';
...
INSERT INTO `ae_account` VALUES (1,'Yanick','Lafontaine','nicelife90','$2y$10$n4QBsVDCa4Gs4og1iz2bT.qBi3wUddOXLSlpbIEim2BTeB56.JvXG','yanicklafontaine@hotmail.com',NULL,'2018-03-04 19:03:32','127.0.0.1',0,-1,'2018-03-01 23:54:41',0,NULL);
...
INSERT INTO `ae_group` VALUES (1,1,'Player','dashboard'),(2,-1,'Developer','dashboard'),(3,3,'Game Master','dashboard'),(4,4,'Administrator','dashboard');
...
CREATE TABLE `ae_menu` (
  ...
  PRIMARY KEY (`id`),
  KEY `menu_id` (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='Menus';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ae_menu` VALUES (4,12,'Configuration','fa-cogs',2),(8,8,'TrinityCore','fa-server',1),(9,-1,'Developer','fa-code',3);
...
CREATE TABLE `ae_module` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COMMENT='Modules';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ae_module` VALUES (1,'Dashboard','dashboard','fa-wrench','1;-1;8;4',-1,1,488,'2018-03-04 19:08:01',1),(2,'Account Management','manage-account','fa-wrench','-1',12,0,112,'2018-03-02 00:10:15',1),(4,'Menu Management','manage-menu','fa-wrench','-1',12,0,202,'2018-03-02 00:20:46',1),(5,'Module Management','manage-module','fa-wrench','-1',12,0,139,'2018-03-02 00:20:33',1),(6,'My Account','profile','fa-wrench','1;-1;8;4',-1,1,108,'2018-02-28 20:36:20',1),(7,'RBAC Management','manage-rbac','fa-wrench','-1',12,0,29,'2018-02-28 20:32:15',1),(8,'Access denied','denied','fa-wrench','1;-1;8;4',-1,1,18,'2018-01-15 20:27:42',1),(39,'Core Management','manage-server','fa-wrench','-1;4',8,0,13,'2018-03-04 19:15:45',1);
...
-- Dump completed on 2018-03-04 14:16:27
