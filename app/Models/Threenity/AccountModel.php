...
class AccountModel
{
    ...
    public static function getAll($include_deleted = false)
    {
        ...
        if ($include_deleted) {
            $accounts = $db->query("SELECT * FROM ae_account");
        } else {
            $accounts = $db->query("SELECT * FROM ae_account WHERE deleted = 0");
        }
    ...
    public static function isDeleted($account_id)
    {
        ...
        $deleted = $db->query("SELECT deleted FROM ae_account WHERE id=$account_id")->fetchObject()->deleted;
    ...
    public static function getById($account_id, $fetch_assoc = false)
    {
        ...
        if ($fetch_assoc) {
            $account = $db->query("SELECT * FROM ae_account WHERE id=$account_id")->fetch(PDO::FETCH_ASSOC);
        } else {
            $account = $db->query("SELECT * FROM ae_account WHERE id=$account_id")->fetchObject();
        }
    ...
    public static function getIdByUsername($username)
    {
        ...
        $id = $db->query("SELECT id FROM ae_account WHERE username='$username'")->fetchObject();
    ...
    public static function getIdByEmail($email)
    {
        ...
        $id = $db->query("SELECT id FROM ae_account WHERE email='$email'")->fetchObject();
    ...
    public static function getFirstName($account_id)
    {
        ...
        $account = $db->query("SELECT first_name FROM ae_account WHERE id=$account_id");
    ...
    public static function getLastName($account_id)
    {
        ...
        $account = $db->query("SELECT last_name FROM ae_account WHERE id=$account_id");
    ...
    public static function getEmail($account_id)
    {
        ...
        $account = $db->query("SELECT email FROM ae_account WHERE id=$account_id");
    ...
    public static function getPassword($account_id)
    {
        ...
        $account = $db->query("SELECT password FROM ae_account WHERE id=$account_id");
    ...
    public static function getLoginAttempt($account_id)
    {
        ...
        $account = $db->query("SELECT login_attempt FROM ae_account WHERE id=$account_id");
    ...
    public static function getInscriptionDate($account_id)
    {
        ...
        $account = $db->query("SELECT inscription_date FROM ae_account WHERE id=$account_id");
    ...
    public static function getLastLoginDate($account_id)
    {
        ...
        $account = $db->query("SELECT last_login_date FROM ae_account WHERE id=$account_id");
    ...
    public static function getLastIp($account_id)
    {
        ...
        $account = $db->query("SELECT last_login_ip FROM ae_account WHERE id=$account_id");
    ...
    public static function getAccountGroup($account_id)
    {
        ...
        $account = $db->query("SELECT account_group FROM ae_account WHERE id=$account_id");
    ...
    public static function getProfileImg($account_id)
    {
        ...
        $account = $db->query("SELECT profile_img FROM ae_account WHERE id=$account_id")->fetchObject()->profile_img;
