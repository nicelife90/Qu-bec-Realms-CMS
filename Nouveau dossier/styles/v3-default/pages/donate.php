...
<div class="page-body">
    <div class="page-space">
        <center>
            ...
            <table align="center">
                <form name="_xclick" action="https://{paypal_url}/cgi-bin/webscr" method="post">
                    <tr>
                        <td>Amount:</td>
                        <td><input type="text" name="amount" id="login" class="minput" AutoComplete="off"></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td></td>
                        <td align="center"><input type="submit" value="Donate" class="msub"></td>
                    </tr>
                </form>
            </table>
        </center>
