...
<div class="title-bar" id="top">
    <div class="tspace">
        New Message &bull; <span style="font-size:11px;"><a href="?page=account#msg">Account</a> - <a
                    href="?page=inbox">Inbox</a> - <a href="?page=outbox">Outbox</a></span>
    </div>
</div>
<div class="page-body">
    <div class="page-space">
        <table>
            <form action="#top" method="post" name="msg" id="msg">
                <tr>
                    <td>To:</td>
                    <td><input type="text" class="minput" name="to" AutoComplete="off" style="width:502px;"
                               value="{msg_user}"></td>
                </tr>
                <tr>
                    <td>Title:</td>
                    <td><input type="text" class="minput" name="title" AutoComplete="off" style="width:502px;"
                               value="{msg_title}"></td>
                </tr>
                <tr>
                    <td>Body:</td>
                    <td><textarea class="minput" style="width:498px; height:125px;" name="body"
                                  id="body">{msg_body}</textarea></td>
                </tr>
                <tr>
                    <td></td>
                    <td align="center">
