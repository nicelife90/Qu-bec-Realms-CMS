    ...
    <div class="page-space">
        <table>
            <form action="#pass" method="POST">
                <tr>
                    <td>Old Password:</td>
                    <td><input type="password" class="minput" name="opassword" AutoComplete="off"></td>
                    <td></td>
                </tr>
                <tr>
                    <td>New Password:</td>
                ...
                <tr>
                    ...
                    <td><input type="password" class="minput" name="cpassword" AutoComplete="off"></td>
                    <td></td>
                </tr>
                <tr>
                    <td></td>
                    <td align="center"><input type="submit" class="msub" name="chp" value="Change Password">
            </form>
            </td>
            <td></td>
        </table>
        ...
        <table>
            <form action="#email" method="POST">
                ...
                <tr>
                    ...
                    <td><input type="text" class="minput" name="cemail" AutoComplete="off"></td>
                    <td></td>
                </tr>
                <tr>
                    <td></td>
                    <td align="center"><input type="submit" class="msub" name="che" value="Change Email">
            </form>
            </td>
            <td></td>
        </table>
