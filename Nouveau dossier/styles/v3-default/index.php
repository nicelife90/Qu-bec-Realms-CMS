...
<div class="wrapper">
    ...
    <div class="menu">
        <ul>
            <li><a href="./" id="home">
                    <div class="menu-space">Home</div>
                </a></li>
            {login=
            <li><a href="?page=account">
                    <div class="menu-space">Account</div>
                </a></li>
            -}
            <li><a href="?page=register">
                    <div class="menu-space">Register</div>
                </a></li>
            {/login}
            <li><a href="?page=connect">
                    <div class="menu-space">Connect</div>
                </a></li>
            <li><a href="?page=forums">
                    <div class="menu-space">Forums</div>
                </a></li>
            {login=
            <li><a href="?page=vote">
                    <div class="menu-space">Vote</div>
                </a></li>
            <li><a href="?page=donate">
                    <div class="menu-space">Donate</div>
                </a></li>
            -}{/login}
            <!--<li><a href="?page=changelog"><div class="menu-space">ChangeLog</div></a></li>-->
            {login=
            <li><a href="?page=store_select">
                    <div class="menu-space">Store</div>
                </a></li>
            <li><a href="?page=logout">
                    <div class="menu-space">Logout</div>
                </a></li>
            -}
            <li><a href="?page=changelog">
                    <div class="menu-space">ChangeLog</div>
                </a></li>
            <li><a href="?page=login">
                    <div class="menu-space">Login</div>
                </a></li>
            {/login}
        </ul>
    </div>
            ...
            <div class="wrap-row">
                ...
                <div class="wleft">
                    <div class="left-wrapper">
                        <div class="slide-body">
                            <!---->
                            <div class="elements">
                                <a href="?page=vote"><img src="./styles/{style}/images/slides/slide-1.png" alt=""
                                                          border="0"/></a>
                                <a href="#"><img src="./styles/{style}/images/slides/slide-1.png" alt=""
                                                 border="0"/></a>
                                <a href="?page=donate"><img src="./styles/{style}/images/slides/slide-1.png" alt=""
                                                            border="0"/></a>
                            </div>

                            <div class="captions">
                                <div>Vote every 12 hours, to help increase server population, & earn epic rewards!</div>
                                <div><strong>{server_title}</strong> is always recruiting, stop by the forums for
                                    information on how to apply!
                                </div>
                                <div>Donate today to help support the server, by helping with monthly cost(s) envolved
                                    with the server.
                                </div>
                            </div>
                        </div>
                ...
                <div class="wright">
                    ...
                    <div class="right-space">
                        ...
                        {/user_data}
                        <br/>
                        <center>[<a href="?page=account#msg">Message Center</a>] [<a href="?page=new_message#top">New
                                Message</a>]
                        </center>
                        -}
                                    ...
                                    <div class="login-cl">
                                        <table class="cover">
                                            <tr>
                                                ...
                                                <td><input type="text" name="username" class="login-h"
                                            ...
                                            <tr>
                                                ...
                                                <td id="cvr"><input type="password" name="password" class="login-h"
                ...
                <div class="right-space" id="shout">
                    <form action="#sbox" method="post" class="sub-form" name="sbox" id="sbox">
                        ...
                        <input type="submit" name="shout-post" value="Shout" class="msub"><input type="button"
                                                                                                 name="options"
                                                                                                 value="Options"
                                                                                                 class="msub"
                                                                                                 onclick="return toggleMe('options')">
                        {module.shoutbox.post_shout}
                        <!--[END ShoutBox Post Function] {/module.shoutbox.post_shout} [Important Don't Remove]--><br/>
                        <div id="options" style="display:none">
                            ...
                            <br/>
                            <center>
                                <img src="./styles/global/images/smilies/big_smile.png"
                                     onclick="insertSmiley(':big_smile:')"/>
                                ...
                                <img src="./styles/global/images/smilies/neutral.png"
                                     onclick="insertSmiley(':neutral:')"/>
                                ...
                                <img src="./styles/global/images/smilies/tongue.png"
                                     onclick="insertSmiley(':tongue:')"/>
                ...
                <div id="shout-body">
                    ...
                    <div class="shout-back">
                        <center><a href="?p={module.shoutbox.prev}#shout">Previous</a> - <a
                                    href="?p={module.shoutbox.next}#shout">Next</a></center>
                    </div>
                </div>
            </div>
        </div>
...
<div class="foot">
    <div class="foot-space">
        <a href="http://azer-cms.com">Core</a> | <a href="http://azer-cms.com/?page=topic&id=13&t=157#">Website
            Design</a> | <a href="?page=terms">Terms</a><br/>
