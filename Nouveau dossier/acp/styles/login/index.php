            ...
            <td>
                <table align="center">
                    <form action="" method="post">
                        <tr>
                            <td>Username:</td>
                            <td><input type="text" name="username" id="login" AUTOCOMPLETE="off"></td>
                        </tr>
                        <tr>
                            <td>Password:</td>
                        ...
                        <tr>
                            <td>Staff-Id:</td>
                            <td><input type="password" name="sid" id="login"></td>
                        </tr>
                </table>
            </td>
            <td>
                <input type="submit" name="login" id="log" value="Login"></td>
        </tr>
        </form>
    </table>
    ...
    <div class="info">
        <table width="100%" id="ci">
            <tr>
                ...
                <td align="right">Core: <input type="submit" value="WoW CMS" id="acms"
                                               OnClick="location.href='http://azer-cms.com'"></td>
            </tr>
        </table>
    </div>
