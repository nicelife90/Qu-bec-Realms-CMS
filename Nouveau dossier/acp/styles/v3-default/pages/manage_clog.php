...
<div class="content-body">
    <div class="cbs">
        ...
        <b>Edit:</b> To edit a changelog post, select the post you want to edit, and click edit. Make wanted changes,
        and then click save.<br/>
        <b>Delete:</b> To delete a changelog post, select the post you want to delete, click edit, and then click
        delete.<br/>
            ...
            <table class="ltlb" cellpadding="0" cellspacing="0">
                    ...
                    <td align="center">
                        <table class="nmt" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td><textarea name="title" class="nmit"
                                              autocomplete="off">{module.changelog.clog.title}</textarea><input
                                            type="hidden" name="nid" value="{module.changelog.clog.id}"></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table class="nmt" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td><textarea name="sbody" class="nmib"
                                              id="form">{module.changelog.clog.body}</textarea></td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td width="80%" align="center"><select name="id" class="nmis">
                            ...
                            {module.changelog.clog_list}
                            <option value="{id}">{title} - By {author}, {date}</option>
                            {/module.changelog.clog_list}</select><input type="submit" name="edit" value="Edit"><input
                                type="submit" name="delete" value="Delete"><input type="submit" name="save"
                                                                                  value="Save"></td>
                </tr>
            </table>
        </form>
