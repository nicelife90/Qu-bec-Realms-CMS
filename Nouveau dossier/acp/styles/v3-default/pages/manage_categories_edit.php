<div class="content-header">
    <div class="chs">Manage Store Categories<span style="margin-left:665px; color:black;">[<a
                    href="./?page=manage_categories" style="color:black;">Category Selection</a>]</span></div>
</div>
...
<div class="content-body">
    <div class="cbsl">
        ...
        <form action="" method="post">{sc_edit}
            <div class="mc">
