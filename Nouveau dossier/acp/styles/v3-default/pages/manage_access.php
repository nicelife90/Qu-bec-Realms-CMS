        ...
        <form action="" method="post">
            <div class="mc">
                <div style="padding:3px 0px 3px 0px;">
                    <table class="ltbl" cellpadding="0" cellspacing="0">
                        <tr id="head">
                            <td width="25%"><input type="text" name="acid" AutoComplete="off" value="Account ID"
                                                   onfocus='if (this.value == "Account ID") this.value = "";'
                                                   onblur='if (!this.value){ this.value = "Account ID"; }'></td>
                            <td width="25%"><select name="glevel">{acls}
                                    <option value="{al1}">{alist}</option>
                                    {/acls}</select></td>
                            <td width="25%">All Realms</td>
