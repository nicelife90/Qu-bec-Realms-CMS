...
<div class="content-body">
    <div class="cbs" style="text-align:center;">
        ...
        <form action="" method="post">
            <select name="realm">{store_realms}
                <option value="{id}">{rname}</option>
                {/store_realms}</select> <input type="text" name="character" class="fsc" AutoComplete="off"><input
                    type="submit" name="find_characters" value="Search">
        </form>
        <br/>
        {account_search}
    </div>
